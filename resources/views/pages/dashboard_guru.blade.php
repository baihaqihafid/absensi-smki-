...
<div class="d-flex justify-content-between align-items-center mb-4 flex-column flex-md-row">
    <h3 class="fw-bold text-dark">Dashboard Guru</h3>
...
<div class="alert alert-info rounded-3 mb-4" role="alert">
    ...
    Jangan lupa <strong>mengisi presensi</strong> sesuai jadwal mengajar hari ini.
    Pastikan memilih <strong>kelas, jurusan, subkelas</strong> dan <strong>mapel</strong> dengan benar.
</div>
