...
<div class="d-flex justify-content-between align-items-center mb-4 flex-column flex-md-row">
    ...
    <p class="text-muted mb-0">Selamat datang, <span class="fw-bold text-primary-pastel">{{ session('nama_lengkap') }}</span>!</p>
</div>

<div class="alert alert-info rounded-3 mb-4" role="alert">
    <i class="fas fa-info-circle me-2"></i>
    Gunakan menu di sebelah kiri untuk mengelola data <strong>siswa</strong>, <strong>guru</strong>, dan <strong>presensi</strong>.
</div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body p-4 d-flex align-items-center">
                <i class="fas fa-calendar-alt fa-3x text-success me-3"></i>
                <div>
